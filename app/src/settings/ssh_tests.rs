...
fn persistent_history_defaults_to_retention_until_explicit_deletion() {
    assert_eq!(
        PersistentHistoryRetention::default(),
        PersistentHistoryRetention::UntilWorkspaceDeleted
    );
    assert_eq!(
        PersistentHistoryRetention::default().to_proto(),
