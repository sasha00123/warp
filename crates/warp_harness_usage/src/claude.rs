...
use crate::{
    ...
    MAX_SCOPE_ENTRIES, ReasonCode, identifier,
};
...
/// Extract cumulative Claude usage from a root history and captured subagent histories.
///
/// Repeated streaming observations are deduplicated by session and response identity, while
